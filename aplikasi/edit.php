...
$edit=mysql_query("select * from produk where kdbrg='$_GET[kdbrg]'");
...
<input type="hidden" name="kode" value="<?php echo $data['0']; ?>" />
	...
	<tr>
		<td align="center"><h2>EDIT PRODUK</h2></td>
	</tr>
	<tr>
		<td>
			<table align="center" border="1" width="45%" bgcolor="#33FF33">
				...
				<tr>
					<td>Type</td>
					<td><input type="text" name="tipe" value="<?php echo $data[2]; ?>"></td>
				</tr>
				<tr>
					<td>Harga</td>
					<td><input type="text" name="harga" value="<?php echo $data[3]; ?>"></td>
				</tr>
				<tr>
					<td>Deskripsi</td>
					<td><textarea name="deskripsi" rows="5" cols="20"><?php echo $data[4]; ?></textarea></td>
				</tr>
				<tr>
					<td>Stok</td>
					<td><input type="text" name="stok" value="<?php echo $data[5]; ?>"></td>
				</tr>
				<!-- <tr>
					<td>Pilih File Gambar</td>
					<td><input type="file" name="gambar"><img src="<?php echo $data['gambar']; ?>" width="50%"></td>
				</tr> -->
				<tr>
					<td></td>
